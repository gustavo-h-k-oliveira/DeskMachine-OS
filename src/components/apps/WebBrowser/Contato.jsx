  ...
  return (
    <div className="frame">
      ...
      <div className="contato-content">
        <h1>Contatos</h1>
        <p>Bem-vindo ao meu cantinho da web! Navegue pelas minhas redes e deixe um recado.</p>
        ...
        <p><strong>Instagram</strong>: <a href="https://www.instagram.com/gustavo.h.k.o/">gustavo.h.k.o</a></p>
      </div>
      <Footer />
    </div>
  );
